...
param = numpy.array([
        ...
        [-10,   60,        15.0],              #12 d1m.1
        [0,     60,        20.0],              #13 d1m.2
        [1,    500,       220.0],              #14 d1m.3
        [0,    500,        50.0],              #15 d1m.4
        [0,      1,      0.1258],              #16 d1m.5
        #
        [0.1,    1,      0.2456],              #17 d1s.1
        #
        [-10,   60,        15.0],              #18 d2m.1
        [0,     60,        20.0],              #19 d2m.2
        [-20,    0,          -5],              #20 d2m.3
        #
        [0.1,    1,      0.2456],              #21 d2s.1
        #
        [-10,   60,        15.0],              #22 d3m.1
        [0,     60,        20.0],              #23 d3m.2
        [1,    500,       220.0],              #24 d3m.3
        [0,    500,        50.0],              #25 d3m.4
        [0,      1,      0.1258],              #26 d3m.5
        #
        [0.1,    1,      0.2456],              #27 d3s.1
        #
        [0,     24,        14.0],              #28 ph.thr
        [0,     10,         1.0]               #29 ph.scale
])
lower = param[:,0]
upper = param[:,1]
