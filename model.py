        ...
        for b in obs:
            ...
            for spc in species:
                ...
                if b['type'] == 'CN0w':
                    ...
                    scr += numpy.nansum(( -numpy.log(gamma.pdf(ss[:,n][ b['days'][1:]*TSCALE ], b[spc][1:]+1, 0, 0.75)) )) # / (b['days'].shape[0]-1.0)
                elif b['type'] == 'AG0':
                    scr += numpy.nansum(( -numpy.log(gamma.pdf(sm[:,n][ b['days'][1:]*TSCALE ], b[spc][1:]+1, 0, 0.75)) )) # / (b['days'].shape[0]-1.0)
                else:
